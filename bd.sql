...
ALTER TABLE `AUTRES_DISPO` ADD `DATE_LIVRAISON` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `LOGICIEL_DISPO` ADD `DATE_LIVRAISON` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `MEMOIRE_DISPO` ADD `DATE_LIVRAISON` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `ORDINATEUR_DISPO` ADD `DATE_LIVRAISON` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
